<template>
  <div id="detail">
    <detail-nav-bar @title-item-click="titleItemClick" ref="navbar"></detail-nav-bar>

    <scroll class="content" ref="scroll" @scroll="detailScroll" :probeType="2">
      <detail-swiper :topImages="topImages" @swiper-image-length="swiperImageLength"></detail-swiper>
      <detail-base-info :goodsInfo="goodsInfo"></detail-base-info>
      <detail-shop-info :shopInfo="shopInfo"></detail-shop-info>
      <detail-goods-info :detailGoodsInfo="detailGoodsInfo" @detailgoodsimgload="detailGoodsImgLoad"></detail-goods-info>
      <detail-param-info :goodsParams="goodsParams" ref="param"></detail-param-info>
...
// import Backtop from "components/content/backtop/Backtop"  通过混入实现
